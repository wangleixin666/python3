...
# mnist数据集中自带分好的train和test的分类，其中有images, labels 维度是

# print(mnist.test.labels.shape) # (10000, 10)
# print(test_y.shape) # (2000, 10) # 只取前2000行
# print(test_x.shape) # (2000, 784) # 也是取前2000行
...
# 重点是变量的shape tf_x要和test_x tf_y和test_y 格式要一致
